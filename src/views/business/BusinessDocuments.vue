            ...
            <div>
              ...
              <div v-if="state.commerce" class="row mb-2">
                <div class="col-8 text-label">
                  <span>{{ $t("businessDocument.listResult") }}</span>
                  <span class="fw-bold m-2">{{ state.documents.length }}</span>
                </div>
                <div class="col-4">
                  <button
              ...
              <div class="document-card mb-4" v-if="state.documents.length > 0 && state.toggles['document-commerce.admin.edit']">
                <div class="my-4">
                  <a class="nav-link document-title centered"
                    data-bs-toggle="collapse"
                    href="#commerce">
                    {{ $t("document.types.COMMERCE") }} ({{ state.groupedDocuments['COMMERCE'] ? state.groupedDocuments['COMMERCE'].length : 0 }}) <i class="bi bi-chevron-down mx-2"></i>
                  </a>
