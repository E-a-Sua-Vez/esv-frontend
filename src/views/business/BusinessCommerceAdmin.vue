...
<template>
  <div>
    <div class="content text-center">
      ...
      <div class="col">
        <a class="btn btn-lg btn-size fw-bold btn-dark rounded-pill mt-2 px-4" @click="goBack()"> {{ $t("businessCommercesAdmin.return") }} <i class="bi bi-arrow-left"></i></a>
      </div>
      <div id="page-header" class="text-center mt-4">
        <span class="welcome-user">{{ $t("businessCommercesAdmin.title") }}</span>
        <ToggleCapabilities
            ...
            <div>
              ...
              <div class="row my-2">
                <div class="col-8 text-label">
                  <span>{{ $t("businessCommercesAdmin.listResult") }}</span>
                  <span class="fw-bold m-2">{{ state.commerces.length }}</span>
                </div>
                <div class="col-4">
                  <button
              ...
              <div id="add-commerce" class="commerce-card mb-4" v-if="state.showAdd && state.toggles['commerces.admin.add']">
              ...
              <div v-for="(commerce, index) in state.commerces" :key="index" class="commerce-card">
                <div class="row">
                  <div class="col-10">
