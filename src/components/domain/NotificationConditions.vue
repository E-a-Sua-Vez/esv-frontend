...
<template>
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <h2 class="portfolio-modal-title mb-0">{{ $t("notificationConditions.title") }}</h2>
        <div class="divider-custom">
          <div class="divider-custom-line"></div>
          <div class="divider-custom-icon"><i class="bi bi-book"></i></div>
          <div class="divider-custom-line"></div>
        </div>
        <p class="mb-4 details"><span class="fw-bold">{{ $t("notificationConditions.subtitle.1") }}</span> {{ $t("notificationConditions.subtitle.2") }}</p>
        <p> Actualizado el 2023-08-01 </p>
        <div class="text">
          <p>Es tu Turno ("nosotros", "nuestro" o "nos") se compromete a proteger su privacidad. Esta Política de privacidad explica cómo Es tu Turno recopila, usa y divulga su información personal.
          </p>
          ...
          <li>Cliente: se refiere a la empresa, organización o persona que se registra para utilizar el Servicio Es tu Turno para gestionar las relaciones con sus consumidores o usuarios del servicio.</li>
          <li>Dispositivo: cualquier dispositivo conectado a Internet, como un teléfono, tablet, computadora o cualquier otro dispositivo que se pueda usar para visitar Es tu Turno y usar los servicios.</li>
          ...
          <li>Personal: se refiere a aquellas personas que son empleadas por Es tu Turno o están bajo contrato para realizar un servicio en nombre de una de las partes.</li>
          ...
          <li>Servicio: se refiere al servicio brindado por Es tu Turno como se describe en los términos relativos (si están disponibles) y en esta plataforma.</li>
          ...
          <p>También recopilamos información de dispositivos móviles para una mejor experiencia de usuario, aunque estas funciones son completamente opcionales:</p><ul><li>Ubicación (GPS): los datos de ubicación ayudan a crear una representación precisa de sus intereses, y esto se puede utilizar para llevar anuncios más específicos y relevantes a los clientes potenciales.</li><li>Cámara (imágenes): otorgar permiso a la cámara le permite al usuario cargar cualquier imagen directamente desde la plataforma, puede denegar de manera segura los permisos de la cámara para esta plataforma.</li>
          </ul>
          <h5>¿Cómo usamos la información que recopilamos?</h5>
          <p>Cualquiera de la información que recopilamos de usted puede usarse de una de las siguientes maneras:
          <ul>
          ...
          <p>Es tu Turno recopilará los datos del usuario final necesarios para proporcionar los servicios de Es tu Turno a nuestros clientes.</p>
          ...
          <p>Recibimos información de terceros cuando se comunica con nosotros. Por ejemplo, cuando nos envía su dirección de correo electrónico para mostrar interés en convertirse en cliente de Es tu Turno, recibimos información de un tercero que brinda servicios automáticos de detección de fraude a Es tu Turno. Ocasionalmente, también recopilamos información que se pone a disposición del público en los sitios web de redes sociales. Puede controlar la cantidad de información que los sitios web de redes sociales hacen pública visitando estos sitios web y cambiando su configuración de privacidad.</p>
          ...
          <p>Es tu Turno recopilará la información personal que nos envíe. También podemos recibir información personal sobre usted de terceros como se describe anteriormente.</p>
          ...
          <p>Los derechos que tienes para solicitar actualizaciones o correcciones de la información que recopila Es tu Turno dependen de tu relación con Es tu Turno. El personal puede actualizar o corregir su información según se detalla en nuestras políticas de empleo internas de la empresa.</p>
          ...
          <h5>Personal</h5>
          <p>Si es un trabajador o solicitante de Es tu Turno, recopilamos la información que nos proporciona voluntariamente. Usamos la información recopilada con fines de recursos humanos para administrar los beneficios a los trabajadores y seleccionar a los solicitantes.</p>
          ...
          <p>Esta Política de privacidad se aplica solo a los Servicios. Los Servicios pueden contener enlaces a otros sitios web que Es tu Turno no opera ni controla. No somos responsables por el contenido, la precisión o las opiniones expresadas en dichos sitios web, y dichos sitios web no son investigados, monitoreados o verificados por nuestra precisión o integridad. Recuerde que cuando utiliza un enlace para ir desde los Servicios a otro sitio web, nuestra Política de privacidad deja de estar en vigor. Su navegación e interacción en cualquier otro sitio web, incluidos aquellos que tienen un enlace en nuestra plataforma, están sujetos a las propias reglas y políticas de ese sitio web. Dichos terceros pueden utilizar sus propias cookies u otros métodos para recopilar información sobre usted.</p>
          <h5>Publicidad</h5>
          <p>Esta plataforma puede contener anuncios de terceros y enlaces a sitios de terceros. Es tu Turno no hace ninguna representación en cuanto a la exactitud o idoneidad de la información contenida en esos anuncios o sitios y no acepta ninguna responsabilidad u obligación por la conducta o el contenido de esos anuncios y sitios y las ofertas realizadas por los terceros.</p>
          <p>La publicidad mantiene a Es tu Turno y muchos de los sitios web y servicios que usted utiliza de forma gratuita. Trabajamos arduamente para asegurarnos de que los anuncios sean seguros, discretos y lo más relevantes posible.</p>
          <p>Los anuncios de terceros y los enlaces a otros sitios donde se anuncian bienes o servicios no son respaldos ni recomendaciones de Es tu Turno de los sitios, bienes o servicios de terceros. Es tu Turno no asume ninguna responsabilidad por el contenido de los anuncios, las promesas hechas o la calidad / confiabilidad de los productos o servicios ofrecidos en todos los anuncios.</p>
          ...
          <p>Usted reconoce y acepta que Es tu Turno no será responsable de ningún Servicio de terceros, incluida su precisión, integridad, puntualidad, validez, cumplimiento de los derechos de autor, legalidad, decencia, calidad o cualquier otro aspecto de los mismos. Es tu Turno no asume ni tendrá ninguna obligación o responsabilidad ante usted o cualquier otra persona o entidad por los Servicios de terceros.</p>
          ...
          <ul><li>API de Google Maps
          <br><br>
          <p>La API de Google Maps es una herramienta sólida que se puede utilizar para crear un mapa personalizado, un mapa de búsqueda, funciones de registro, mostrar la sincronización de datos en vivo con la ubicación, planificar rutas o crear un mashup, solo por nombrar algunos.</p>
          <p>La API de Google Maps puede recopilar información suya y de su dispositivo por motivos de seguridad.</p>
          <p>La API de Google Maps recopila información que se mantiene de acuerdo con su Política de privacidad.</p></li><br><li>Cookies
          <br><br>
          <p>Usamos Cookies para mejorar el rendimiento y la funcionalidad de nuestra plataforma, pero no son esenciales para su uso. Sin embargo, sin estas cookies, es posible que ciertas funciones, como los videos, no estén disponibles o se le solicitará que ingrese sus datos de inicio de sesión cada vez que visite la plataforma, ya que no podríamos recordar que había iniciado sesión anteriormente.</p>
          </li><br><li>Sesiones
          <br><br>
          <p>$elnombre utiliza "Sesiones" para identificar las áreas de nuestro sitio web que ha visitado. Una sesión es un pequeño fragmento de datos que su navegador web almacena en su computadora o dispositivo móvil.</p></li><br>
          </ul>
          <h5>Información sobre el Reglamento general de protección de datos (RGPD)</h5>
          <p>Es posible que recopilemos y utilicemos información suya si pertenece al Espacio Económico Europeo (EEE), y en esta sección de nuestra Política de privacidad vamos a explicar exactamente cómo y por qué se recopilan estos datos, y cómo los mantenemos bajo protección contra la replicación o el uso incorrecto.</p>
          <h5>¿Qué es RGPD?</h5>
          <p>RGPD es una ley de privacidad y protección de datos en toda la UE que regula cómo las empresas protegen los datos de los residentes de la UE y mejora el control que los residentes de la UE tienen sobre sus datos personales.</p>
          <p>El RGPD es relevante para cualquier empresa que opere a nivel mundial y no solo para las empresas con sede en la UE y los residentes de la UE. Los datos de nuestros clientes son importantes independientemente de dónde se encuentren, por lo que hemos implementado controles RGPD como nuestro estándar de referencia para todas nuestras operaciones en todo el mundo.</p>
          <h5>¿Qué son los Datos Personales?</h5>
          <p>Cualquier dato que se relacione con un individuo identificable o identificable. El RGPD cubre un amplio espectro de información que podría usarse por sí sola o en combinación con otras piezas de información para identificar a una persona. Los datos personales van más allá del nombre o la dirección de correo electrónico de una persona. Algunos ejemplos incluyen información financiera, opiniones políticas, datos genéticos, datos biométricos, direcciones IP, dirección física, orientación sexual y origen étnico.</p>
          ...
          <p>La Ley de Privacidad del Consumidor de California (CCPA) requiere que divulguemos las categorías de Información personal que recopilamos y cómo la usamos, las categorías de fuentes de las que recopilamos Información personal y los terceros con quienes la compartimos, que hemos explicado anteriormente. </p>
          <p>También estamos obligados a comunicar información sobre los derechos que tienen los residentes de California según la ley de California. Puede ejercer los siguientes derechos:</p>
          <ul>
          <li>Derecho a conocer y acceder. Puede enviar una solicitud verificable de información con respecto a: (1) categorías de Información personal que recopilamos, usamos o compartimos; (2) fines para los que recopilamos o utilizamos categorías de información personal; (3) categorías de fuentes de las que recopilamos información personal; y (4) piezas específicas de información personal que hemos recopilado sobre usted.</li>
          <li>Derecho a la igualdad de servicio. No lo discriminaremos si ejerce sus derechos de privacidad.</li>
          <li>Derecho a eliminar. Puede enviar una solicitud verificable para cerrar su cuenta y eliminaremos la Información personal sobre usted que hayamos recopilado.</li>
          <li>Solicite que una empresa que vende los datos personales de un consumidor, no venda los datos personales del consumidor.</li>
          </ul>
          ...
          <p>CalOPPA requiere que divulguemos las categorías de información personal que recopilamos y cómo la usamos, las categorías de fuentes de las que recopilamos la información personal y los terceros con quienes la compartimos, lo cual explicamos anteriormente.</p>
          ...
          <ul><li>A través de correo electrónico: hola@estuturno.app</li><li>A través de este enlace: https://estuturno.app</li></ul>
        </div>
      </div>
    </div>
  </div>
