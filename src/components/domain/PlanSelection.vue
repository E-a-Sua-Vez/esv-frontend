  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-8">
        ...
        <p class="mb-4 details">
          <span class="fw-bold">{{ $t('planSelection.subtitle.1') }}</span>
          {{ $t('planSelection.subtitle.2') }}
        </p>
        <div class="m-2">
          <Plan :plan="plan" :selectionable="false" :selected-plan="{}"> </Plan>
        </div>
        <div>
          <div class="payment-card m-3 p-3">
            <div class="centered">
              <span> <i class="h1 bi bi-cash-coin"></i> </span>
              <span class="details m-2"> {{ $t('planSelection.canPayWays') }} </span>
            </div>
            <div class="card-body mt-4">
              <div class="row g-1">
                ...
                <a class="col-8 nav-link benefits-title" data-bs-toggle="collapse" :href="`#wire`">
              ...
              <div :id="`wire`" class="row collapse benefits-list ml-4">
                <ul class="list list-unstyled mb-0 m-2">
                  <li>
                    <span class="fw-bold"> {{ $t('planSelection.bank') }}</span
                    ><span> N/A </span>
                  </li>
                  <li>
                    <span class="fw-bold"> {{ $t('planSelection.accountType') }}</span
                    ><span> N/A </span>
                  </li>
                  <li>
                    <span class="fw-bold"> {{ $t('planSelection.accountNumber') }}</span
                    ><span> N/A </span>
                  </li>
                  <li>
                    <span class="fw-bold"> {{ $t('planSelection.id') }}</span
                    ><span> N/A </span>
                  </li>
                </ul>
              </div>
            ...
            <div class="card-body mt-2">
              <div class="row g-1">
                ...
                <a class="col-8 nav-link benefits-title">
        ...
        <div class="recaptcha-area plan-select-title form-check m-2">
          ...
          <label class="form-check-label label-conditions text-left" for="conditions">
            ...
            <a href="#conditionsModal" data-bs-toggle="modal" data-bs-target="#conditionsModal">
              {{ $t('businessPlan.acceptData.2') }}</a
            >
            {{ $t('businessPlan.acceptPurchase.1') }}
            <a href="#useConditionsModal" data-bs-toggle="modal" data-bs-target="#conditionsModal">
              {{ $t('businessPlan.acceptPurchase.2') }}</a
            >
          </label>
        </div>
        <a
          ...
          @click="select(plan, acceptTerms)"
          >{{ $t('planSelection.action') }} <i class="bi bi-check-lg"></i>
        </a>
