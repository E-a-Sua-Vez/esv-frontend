        ...
        <div id="patient-history-resume">
          <div class="row">
            ...
            <div class="lefted resume-patient-title">
              ...
              <span class="mx-1">{{ patientHistoryData.personalData?.name }} </span>
              <span class="mx-1">{{ patientHistoryData.personalData?.lastName }} </span>
            </div>
            <div
              class="lefted resume-patient-subtitle"
          ...
          <div id="patientAnamnese-data">
            <div v-if="patientHistoryData?.patientAnamnese">
              <div class="row m-1 mb-2">
                <div class="col-12 text-label badge bg-secondary title-section">
                  <span
                    >{{ $t('patientHistoryView.patientAnamnese') }}
                    <i class="bi bi-person-fill mx-1"></i
                  ></span>
                </div>
              </div>
          ...
          <div id="physicalExam-data">
            ...
            >
              <div class="row m-1 mb-2">
                <div class="col-12 text-label badge bg-secondary title-section">
                  <span
                    >{{ $t('patientHistoryView.physicalExam') }}
                    <i class="bi bi-person-fill mx-1"></i
                  ></span>
                </div>
              </div>
          ...
          <div id="diagnostic-data">
            ...
            >
              <div class="row m-1 mb-2">
                <div class="col-12 text-label badge bg-secondary title-section">
                  <span
                    >{{ $t('patientHistoryView.diagnostic') }} <i class="bi bi-person-fill mx-1"></i
                  ></span>
                </div>
              </div>
              <div
