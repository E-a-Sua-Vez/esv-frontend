                          ...
                          <div class="row centered">
                              ...
                              <i
                                :class="
                                  getTrendIcon(
                                    ...
                                    calculatedMetrics['attention.created'].pastPeriodAttentionNumber
                                      .number
                                  )
                                "
                              >
                            ...
                            <div class="col-12 col-md-4 m-1 centered">
                              <span>
                                ...
                                <span class="fw-bold">
                                  {{
                                    (calculatedMetrics['attention.created'].dailyAvg || 0).toFixed(
                                      2
                                    )
                                  }}
                                </span>
                              ...
                              <i
                                :class="
                                  getTrendIcon(
                                    ...
                                    calculatedMetrics['attention.created'].pastMonthAttentionNumber
                                      .number
                                  )
                                "
                              >
                  ...
                  <div v-if="toggles['dashboard.survey-flow.view']" class="col">
                    <div class="card metric-card-graph h6 centered">
                      ...
                      <div class="col-12 mt-2">
                        <div
                          class="row centered m-1"
                          v-for="(option, ind) in calculatedMetrics['attention.created'].surveyFlow
                            .labels"
                          :key="`option.${ind}`"
                        >
                          <div class="col-6 centered">
                        ...
                        <div class="row centered">
                          ...
                          <div class="col-12 col-md-4 m-1 centered">
                            <span>
                              ...
                              <span class="fw-bold">
                                {{ calculatedMetrics['attention.created'].avgRateDuration }} </span
                              >.
                            </span>
                          </div>
                          <div class="col-12 col-md-4 m-1 centered">
                ...
                >
                  ...
                  >
                    <div class="card col metric-card-graph centered">
                      <div class="metric-card-title">
                        <span
                          ><strong> {{ $t('dashboard.items.attentions.graph.13') }} </strong></span
                        >
                      </div>
                      <LineChart
                        class="centered"
                ...
                >
                  ...
                  >
                    <div class="card col metric-card-graph centered">
                      <div class="metric-card-title">
                        <span
                          ><strong> {{ $t('dashboard.items.attentions.graph.10') }} </strong></span
                        >
                      </div>
                      <div class="row">
                        <LineChart
                ...
                <div v-if="graphs['booking-flow']" class="row row-cols-1 row-cols-md-1 g-2 mx-2">
                  <div v-if="toggles['dashboard.booking-flow.view']" class="col">
                    <div class="card metric-card-graph h6 centered">
                      <div class="metric-card-title">
                        <span
                          ><strong> {{ $t('dashboard.items.attentions.graph.11') }} </strong></span
                        >
                      </div>
                      ...
                      <div class="col-12 mt-2">
                        <div
                          class="row centered m-1"
                          v-for="(option, ind) in calculatedMetrics['booking.created'].bookingFlow
                            .labels"
                          :key="`option.${ind}`"
                        >
                          <div class="col-6 centered">
                ...
                >
                  ...
                  >
                    <div class="card col metric-card-graph centered">
                      <div class="metric-card-title">
                        <span
                          ><strong> {{ $t('dashboard.items.attentions.graph.12') }} </strong></span
                        >
                      </div>
                      <LineChart
                        class="centered"
                ...
                >
                  ...
                  >
                    <div class="card col metric-card-graph centered">
                      <div class="metric-card-title">
                        <span
                          ><strong> {{ $t('dashboard.items.attentions.graph.14') }} </strong></span
                        >
                      </div>
                      <LineChart
                        class="centered"
