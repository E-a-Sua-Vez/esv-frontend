    ...
    <div v-show="!isCollapsed" class="picker-body">
      ...
      <div class="quick-help mt-2">
        ...
        <small class="text-muted">
          <strong>{{ t('pdfTemplates.canvasEditor.variables.tip') }}</strong> {{ t('pdfTemplates.canvasEditor.variables.helpTip') }}
        </small>
      </div>
    </div>
  </div>
  ...
  examOrder: {
    ...
    variables: [
      ...
      },
      {
        ...
        description: t('pdfTemplates.canvasEditor.variables.items.clinicalJustification.description'),
      ...
      },
      {
        ...
        description: t('pdfTemplates.canvasEditor.variables.items.preparationInstructions.description'),
