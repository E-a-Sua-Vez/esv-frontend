    ...
    <div class="row metric-card fw-bold">
      <div class="idNumber-title lefted" v-if="client && client.userName">
        ...
        <span class="mx-1"
          ...
          {{ client.userLastName?.trim().toUpperCase() || '' }}</span
        >
      </div>
      <div class="col-7 card-client-title lefted">
        ...
        <span class="badge rounded-pill bg-primary metric-keyword-tag mx-1 fw-bold">
          {{ client.attentionsCounter || 0 }}
        </span>
        <i v-if="client.surveyId" class="bi bi-star-fill mx-1 yellow-icon"> </i>
        <i
          v-if="client.firstAttentionForm === true"
          class="bi bi-clipboard2-pulse-fill mx-1 blue-icon"
        >
        </i>
      </div>
      <div class="col-2 centered card-client-title">
        <i :class="`bi ${clasifyDaysSinceComment(client.daysSinceAttention || 0)} mx-1`"></i>
        {{ client.daysSinceAttention || 0 }}
      </div>
      <div class="col-3 centered card-client-title">
        ...
        <i :class="`bi ${clasifyDaysContacted(client.daysSinceContactedClient || 0)} mx-1`"> </i>
        {{ client.daysSinceContactedClient || 0 }}
      </div>
    </div>
        ...
        <div class="row centered my-2" v-if="management && !loading">
          ...
          <div class="col-3">
            ...
            >
              ...
              <i v-if="client.pendingBookings > 0" class="bi bi-circle-fill green-icon"> </i>
          ...
          <div class="col-4">
            ...
            >
              ...
              <i v-if="client.pendingControls > 0" class="bi bi-circle-fill yellow-icon"> </i
              ><i class="bi bi-file-medical-fill mx-1"></i>
            </button>
          </div>
        </div>
        <hr />
          ...
          <div class="col">
            <div v-if="client.rating || client.nps">
              <div class="mb-2">
                ...
                <span class="mb-1">{{ $t('dashboard.surveyData') }}</span>
              </div>
              <span class="badge mx-1 detail-data-badge">
                CSAT <i class="bi bi-star-fill yellow-icon"></i> {{ client.rating || 'N/I' }}
              </span>
              <span class="badge mx-1 detail-data-badge">
            ...
            >
              ...
              >
              <span
                v-if="client.packageId && client.packageName"
                class="badge mx-1 detail-data-badge"
              >
                <span class="fw-bold detail-data-badge-title">
                ...
                {{ client.packageName }}
                <span class="badge mx-1 bg-secondary"
              ...
              <span v-if="client.attentionCreatedDate" class="badge mx-1 detail-data-badge">
                ...
                {{ getDate(client.attentionCreatedDate) }} </span
              ><br />
              <hr />
            </div>
            <div
            ...
            >
              <div class="mb-2">
                ...
                <span class="mb-1">{{ $t('dashboard.personalData') }}</span>
              </div>
              ...
              <span v-if="client.userAddressText" class="badge mx-1 detail-data-badge">
                <span class="fw-bold detail-data-badge-title">
                  {{ $t('commerceQueuesView.addressText') }}
                </span>
            ...
            <div class="mt-2">
              ...
              <span class="metric-card-details"
                ><strong>Date:</strong>
                {{ getDate(client.attentionCreatedDate || client.clientCreatedDate) }}</span
              >
            </div>
          </div>
        </div>
        ...
        <div class="modal-content">
          <div class="modal-header border-0 centered active-name">
            <h5 class="modal-title fw-bold">
              <i class="bi bi-qr-code"></i> {{ $t('dashboard.attentionsOf') }}
    ...
    >
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <div class="modal-header border-0 centered active-name">
            <h5 class="modal-title fw-bold">
              <i class="bi bi-calendar-fill"></i> {{ $t('dashboard.bookingsOf') }}
              {{ client.userName || client.userIdNumber || client.userEmail }}
            </h5>
            <button
              class="btn-close"
    ...
    >
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <div class="modal-header border-0 centered active-name">
            <h5 class="modal-title fw-bold">
              <i class="bi bi-pencil-fill"></i> {{ $t('dashboard.dataOf') }}
    ...
    >
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <div class="modal-header border-0 centered active-name">
            <h5 class="modal-title fw-bold">
              <i class="bi bi-chat-left-dots-fill"></i> {{ $t('dashboard.contactsOf') }}
              {{ this.client.userName || this.client.userIdNumber || this.client.userEmail }}
            </h5>
            <button
              class="btn-close"
