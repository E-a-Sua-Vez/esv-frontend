  ...
  <div v-if="show">
    <div class="row metric-card">
      <div class="col centered fw-bold date-title" v-if="product && product.consumptionAmount">
        {{ product.productName }} - {{ product.consumptionAmount }}
          ...
          <div class="col">
            <div class="">
              ...
              <span v-if="product.comsumptionAttentionId" class="badge mx-1 detail-data-badge">
                <span class="fw-bold detail-data-badge-title">
                  {{ $t('paymentData.attentionId') }}
                </span>
                <i class="bi bi-qr-code mx-1"> </i> {{ product.comsumptionAttentionId }} </span
              ><br /><br />
