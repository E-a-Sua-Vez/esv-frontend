...
<template>
  <div>
    ...
    <div
      ...
      class="row"
      v-if="showProductStockManagement === true && toggles['products-stock.attentions.view']"
    >
      <div class="col">
                  ...
                  <div class="row">
                    <div class="col-12 col-md-6">
                      <div class="form-check form-switch centered">
                        <input
                          class="form-check-input m-1"
                          :class="stock === false ? 'bg-danger' : ''"
                          type="checkbox"
                          name="stock"
                          id="stock"
                          v-model="stock"
                          @click="checkStock($event)"
                        />
                        <label class="form-check-label metric-card-subtitle" for="stock">{{
                          $t('dashboard.stock')
                        }}</label>
                      </div>
                    </div>
